...
<body>
    <header class="header-base">
            ...
            <div class="menu-ctn">
                ...
                <div id="menu-grid">
                    ...
                    <div class="menu-link_ctn">
                        ...
                        <!-- <div class="menu-link">
                            <a href="#" class="link_name">PROJEKTE</a>
                        </div>
                        <div class="menu-link">
                            <a href="#" class="link_name">DESIGN</a>
                        </div>
                        <div class="menu-link">
                            <a href="#" class="link_name">PROZESSAUTOMATISIEREUNG</a>
                        </div>
                        <div class="menu-link">
                            <a href="#" class="link_name">SUCHMASCHINENMARKETING</a>
                        </div>
                        <div class="menu-link">
                            <a href="#" class="link_name">KONTAKT</a>
                        </div> -->
                    </div>
                </div>
            </div>
        ...
        <!-- <img src="asset/svg/follow-arrow.svg" alt="nach unten scrollen" class="follow-arrow"> -->
        <!-- </div> -->
    </header>